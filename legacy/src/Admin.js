...
class Admin extends React.Component {
  ...
  adminVote(){
    ReactDOM.render(<VotingModal token={this.state.token}
  ...
  render() {
    ...
    return (
      ...
      <div className="content-section ">
        <h2 className="content-section-title"><i className="fas fa-user-secret fa-fw" /> <span className="u-highlight">Admin Dashboard</span></h2>
        <div className="content-section-desc admin">
        ...
        Object.keys(this.state.user).map(k =>
          (<div className="form-check form-check-inline">
            ...
            <AdminEmailing token={this.state.token}
              user={this.state.user}
            />}
          </div>
        </div>
