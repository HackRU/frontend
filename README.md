...
2.  Run `nvm install 10` to get the stable release of Node version 10.  Double check with `node -v`.  Then install all the dependencies listed in `package.json` using `npm install`.
