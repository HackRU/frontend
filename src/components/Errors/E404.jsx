...
class E404 extends Component {
    render() {
        return (
            <Container fluid
                style={{ width: "100%", height: "100vh", textAlign: "center", backgroundColor: theme.secondary[1] }}
                ...
                <Col xs={4}
                    ...
                    <div style={{ padding: 30 }}>
                        ...
                        <Link to="/"
                            style={{ color: "white" }}><p className="lead">Click here to go back to land!</p></Link>
                    </div>
                </Col>
                <Col />
            </Container>
