...
function Schedule() {
	...
	function fill_table(schedule) {
		...
		schedule.forEach((row, index) => {
			rows.push(
				<TableRow style={index % 2 === 0 ? light_red : dark_red} key={index} className="lead">
		...
		return (
			<div style={{ overflowX: "auto" }}>
				<TableContainer>
					<Table size="large" style={{ minWidth: 300 }} hover borderless>
			...
			<div className="row mb-3" style={{ marginLeft: -50, marginRight: -50 }}>
				...
				>
					<Grid container>
						...
						>
							<h3 style={{ paddingLeft: 10 }} className="lead">
								{saturday_date}
							</h3>
						</Grid>
