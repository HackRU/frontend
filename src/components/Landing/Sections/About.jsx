...
function About() {
	return (
		<Card backgroundColor={theme.secondary[1]} sideBar={theme.accent[0]}>
			...
			>
				<img alt="background" src={"./assets/background/shape_green.svg"} height={100} />
			</div>
			...
			<div className="row mb-3" style={{ marginLeft: -50, marginRight: -50 }}>
				...
				>
					...
					<p style={{ display: "inline-block" }} className="lead">
						HackRU is a 24-hour hackathon at Rutgers University. We welcome hundreds of students to
						join us in building awesome tech projects. Industry experts and mentors help foster an
						atmosphere of learning through tech-talks and one-on-one guidance. We encourage all
						students, no matter their experience level or educational background, to challenge
						themselves and expand their creative, technical, and collaboration skills at HackRU.
					</p>
				</div>
				<div
					style={{ color: "white", padding: 50, paddingBottom: 0 }}
				...
				<div style={{ color: "white", padding: 50 }} className="col-xs-12 col-sm-12">
					...
					<p className="lead">
						College Avenue Student Center: 126 College Ave, New Brunswick, NJ 08901
					</p>
					<iframe
						title="about-map"
						frameBorder={0}
