...
import { Icon } from "react-fa"; //depricated Author Message: Use https://github.com/FortAwesome/react-fontawesome instead
            ...
            <div style={{ backgroundColor: theme.secondary[1], color: "white", boxShadow: "0px 0px 10px rgba(0, 0, 0, 0.5)", padding: 50, paddingBottom: 0 }}>
                ...
                <div className="row mb-3"
                    ...
                    <div style={{ color: "white", padding: 50, paddingBottom: 0 }}
                        ...
                        <p className="lead">HackRU is from October TBDth-TBDth 2020.</p>
                    </div>
                    <div style={{ color: "white", padding: 50 }}
                        ...
                        <p className="lead">Due to safetey concerns from COVID-19, HackRU will be held online.</p>
