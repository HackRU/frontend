...
const Content = ({ children, appointmentData, classes, ...restProps }) => (
    <AppointmentTooltip.Content {...restProps} appointmentData={appointmentData}>
        <Grid container alignItems="center">
            <Grid item xs={10} style={{ paddingLeft: 20, paddingBottom: 10, color: "rgba(150, 150, 150, 1)" }}>
                <RoomIcon /> <span style={{ paddingLeft: 17 }} dangerouslySetInnerHTML={{ __html: appointmentData.location ? appointmentData.location : "<i>nothing to see here</i>" }} />
            </Grid>
            <Grid item xs={10} style={{ marginLeft: 30, paddingTop: 10,  borderTop: "1px solid rgba(200, 200, 200, 1)", color: "rgba(150, 150, 150, 1)" }}>
                <div style={{ }}> <span dangerouslySetInnerHTML={{ __html: appointmentData.description ? appointmentData.description : "<i>nothing to see here</i>" }} /> </div>
            </Grid>
        </Grid>
