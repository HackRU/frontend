                ...
                >
                    ...
                    <FormGroup row>
                        <Col xs={mobile ? 12 : 4}>
                            <AvField
                                ...
                                onChange={e => {
                                    user.phone_number = e.target.value;
                                    this.updateUser(user);
                                }}
                                validate={{
                            ...
                            >
                                <div className="forcestyle">
                                    <Select
                                        ...
                                        value={{
                                            value: user.shirt_size,
                                            label: user.shirt_size,
                                        }}
                                        onChange={e => {
                                            user.shirt_size = e.value;
                                            this.updateUser(user);
                                        }}
                            ...
                            <AvField
                                ...
                                validate={{
                                    ...
                                    max: {
                                        value: 2030,
                                        errorMessage:
                                            "Graduation year must be between 2019 and 2030",
                                    },
                                    min: {
                                        value: 2019,
                                        errorMessage:
                        ...
                        <Col xs={mobile ? 12 : 6}>
                            <CustomAVInput
                                ...
                                validate={{
                                    required: {
                                        value: true,
                                        errorMessage: "Invalid level of study",
                                    },
                                }}
                            >
                                <div className="forcestyle">
                    ...
                    <FormGroup>
                        ...
                        <Input
                            ...
                            onChange={e => {
                                user.dietary_restrictions = e.target.value;
                                this.updateUser(user);
                            }}
                        />
                    </FormGroup>
                    <FormGroup>
                        ...
                        <Input
                            ...
                            onChange={e => {
                                user.special_needs = e.target.value;
                                this.updateUser(user);
                            }}
                        />
                    </FormGroup>
                        ...
                        <div className="forcestyle">
                            <Creatable
                                ...
                                onChange={e => {
                                    ...
                                    majors = majors.substring(1);
                                    user.how_you_heard_about_hackru = majors;
                                    this.updateUser(user);
                                }}
                    ...
                    <FormGroup>
                        ...
                        <Input
                            ...
                            onChange={e => {
                                user.short_answer = e.target.value;
                                this.updateUser(user);
                            }}
                        />
                    </FormGroup>
                    ...
                    >
                        <AvCheckbox
                            ...
                            onChange={() => {
                                this.setState({
                                    checkedState1: !this.state.checkedState1,
                                });
                            }}
                            label={
                                <p>
