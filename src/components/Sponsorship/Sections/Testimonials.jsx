                ...
                <div class="col-lg-3">
                    <div class="hpanel testimo-panel text-center">
                        <div> 
                            ...
                            <h3>Sunny Feng</h3>
                            <div class="font-bold m-b-xs">Electrical and Computer Engineering, Computer Science, 2020</div><hr />
                            <p>
                ...
                <div class="col-lg-3">
                    <div class="hpanel testimo-panel text-center">
                        <div>
                            ...
                            <h3>Naeem Hossain</h3>
                            <div class="font-bold m-b-xs">Computer Science, Information Technology and Informatics, 2018</div><hr />
                            <p>
                ...
                <div class="col-lg-3">
                    <div class="hpanel testimo-panel text-center">
                        <div >
                            ...
                            <h3>Mihai Andrei</h3>
                            <div class="font-bold m-b-xs"> Mathematics & Computer Science, 2019</div><hr />
                            <p>
                ...
                <div class="col-lg-3">
                    <div class="hpanel testimo-panel text-center">
                        <div>
                            ...
                            <div class="font-bold m-b-xs"> Psychology & Computer Science, 2018</div><hr />
                            <p>
