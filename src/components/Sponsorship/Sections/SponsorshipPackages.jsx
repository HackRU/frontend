...
function check(){ return <i className="fa fa-check-square-o fa-2x"
    style={{color: "#ffd562"}}></i>;}
                ...
                <Table className={classes.table}>
                    <TableHead>
                        <TableRow>
                            ...
                            <StyledTableCell width="150dp"
                                align="center">BRONZE</StyledTableCell>
                            <StyledTableCell width="150dp"
                                align="center">SILVER</StyledTableCell>
                            <StyledTableCell width="150dp"
                                align="center">GOLD</StyledTableCell>
                            <StyledTableCell width="150dp"
                                align="center">PLATINUM</StyledTableCell>
                            <StyledTableCell width="150dp"
                        ...
                        {rows.map(row => (
                            <StyledTableRow key={row.offer}>
                                <StyledTableCell component="th"
                                    scope="row">{row.offer}</StyledTableCell>
