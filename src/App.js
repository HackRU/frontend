          ...
          <h4>{this.state.errorMessage}</h4>
				...
				<div className="form-group row my-5">
					<div className="col-12 text-center">
						<br/>
						<button onClick={this.login} type="button" className="btn btn-primary custom-btn" data-toggle="modal" data-target="#exampleModalCenter"><h4 className="my-0">Login</h4></button>
