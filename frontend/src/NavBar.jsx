...
import "./NavBar.css";
import Logo from "./core/Landing/Sections/Logo";
...
class NavBar extends Component {
    ...
    handleResize() {
        ...
        this.setState({
            badgeHeight: parseFloat(
                window.getComputedStyle(badge).getPropertyValue("height").replace("px", "")
            ),
        });
    }
    ...
    getLandingNav() {
        return <React.Fragment>{this.getNavLinks()}</React.Fragment>;
    }
    getDashboardNav() {
        return (
            <React.Fragment>
