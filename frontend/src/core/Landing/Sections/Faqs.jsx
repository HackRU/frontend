...
const FAQTextTwo = {
    one: {
        ...
        text: [
            <p key={1}>
                HackRU welcomes undergraduate and graduate students of all majors, backgrounds, and
                skill levels to come create. Additionally, high school students who will be 18 by
                HackRU are allowed to register.{" "}
                <i>
                    Unfortunately, if you are under 18, you will not be able to attend, unless you
                    are also a Rutgers student.
                </i>
            </p>,
        ],
    },
...
function Faqs(props) {
    ...
    return (
        ...
        >
            ...
            ></div>
            <h1 style={{ marginBottom: 25 }} className="display-4 theme-font">
                FAQs
            </h1>
